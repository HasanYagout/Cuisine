    ...
    if($_SESSION['type']==0)
    {
     ...
     ";
      ...
      if(isset($_POST['submit']))
      {
        ...
        $query="insert into $table values(null,'$firstname','$lastname','$email','$password','profile',0)";
       ...
       $_SESSION['lastname']=$row1['lastname'];
        ...
        if($_SESSION['type']==0)
        {
          ...
          session_start();
            echo"<script language=javascript 
            type=text/javascript>
            self.location.href='admin_index.php?id=$_SESSION[id]';
            </script>";
        }
...
<div class="pic">
 <div class="pic2">
  ...
  <div class="banner_content">
    ...
    <?php echo "<h3>My Account</h3>"." ".$_SESSION['firstname']; ?><br>
